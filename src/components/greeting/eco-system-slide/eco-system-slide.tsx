...
export const EcoSystemSlide = () => {
  ...
  const {platform} = useMediaQuery('(width <= 500px)', '(width <= 900px)')
  ...
  return (
    <div className={styles.main}>
      ...
      <div className={styles.items}>
        ...
        <ItemEcoSystem className={clsx(platform === 'desktop' ? styles.item_row : styles.item_column)} image={image_fourth} title={`Биржа инноваций`} paddingImageWrapper={'0 40px 0 0'}
        ...
        <ItemEcoSystem className={styles.item_row} image={image_fifth} title={`Финтех`} paddingImageWrapper={platform === 'phone' ? '0' : '20px'}
